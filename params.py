...
def get_params():
    ...
    params.q_learning.alpha = 0.008 # [SH=0.2, CH=-0.2, PD=0.2, NPIPD = 0.01]

    # N Player Prisoner's Dilemma 
    params.npipd.N = 64 # 64 # 128
    params.npipd.f = 2.0
    
    # penalization
    params.penalization = True
    params.penalty = -170 # [SH=-2.0, CH=-2.0, PD=-2.0, NPIPD_32=-70, NPIPD_64=-160, NPIPD=128=-300]
